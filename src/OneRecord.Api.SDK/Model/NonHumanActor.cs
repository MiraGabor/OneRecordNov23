...
namespace OneRecord.Api.SDK.Model
{
    ...
    /// NonHumanActor
    /// </summary>
    [DataContract(Name = "NonHumanActor")]
    public partial class NonHumanActor : IEquatable<NonHumanActor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NonHumanActor" /> class.
        /// </summary>
        ...
        {
            return this.Equals(httpsInput as NonHumanActor);
        }

        /// <summary>
        /// Returns true if NonHumanActor instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of NonHumanActor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NonHumanActor httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
