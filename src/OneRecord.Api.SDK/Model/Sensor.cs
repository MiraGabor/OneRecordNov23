...
namespace OneRecord.Api.SDK.Model
{
    ...
    public partial class Sensor : IEquatable<Sensor>, IValidatableObject
    {
        ...
        {
            return this.Equals(httpsInput as Sensor);
        }

        /// <summary>
        /// Returns true if Sensor instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of Sensor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Sensor httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
