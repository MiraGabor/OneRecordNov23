...
namespace OneRecord.Api.SDK.Model
{
    ...
    public partial class LogisticsEvent : IEquatable<LogisticsEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogisticsEvent" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogisticsEvent {\n");
        ...
        {
            return this.Equals(httpsInput as LogisticsEvent);
        }

        /// <summary>
        /// Returns true if LogisticsEvent instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of LogisticsEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogisticsEvent httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
