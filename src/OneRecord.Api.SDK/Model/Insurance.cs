...
namespace OneRecord.Api.SDK.Model
{
    ...
    public partial class Insurance : IEquatable<Insurance>, IValidatableObject
    {
        ...
        /// <param name="httpsCargocoveringOrganization">CargocoveringOrganization.</param>
        /// <param name="httpsCargoinsuredAmount">CargoinsuredAmount.</param>
        /// <param name="httpsCargoinsuredShipment">CargoinsuredShipment.</param>
        /// <param name="httpsCargonvdIndicator">CargonvdIndicator.</param>
        public Insurance(string httpsId = default(string), List<string> httpsType = default(List<string>), List<Check> httpsCargochecks = default(List<Check>), List<LogisticsEvent> httpsCargoevents = default(List<LogisticsEvent>), List<ExternalReference> httpsCargoexternalReferences = default(List<ExternalReference>), string httpsCargocompanyIdentifier = default(string), bool httpsCargoskeletonIndicator = default(bool), Organization httpsCargocoveringOrganization = default(Organization), Value httpsCargoinsuredAmount = default(Value), Shipment httpsCargoinsuredShipment = default(Shipment), bool httpsCargonvdIndicator = default(bool))
        {
            ...
            this.HttpsCargocoveringOrganization = httpsCargocoveringOrganization;
            this.HttpsCargoinsuredAmount = httpsCargoinsuredAmount;
            this.HttpsCargoinsuredShipment = httpsCargoinsuredShipment;
            this.HttpsCargonvdIndicator = httpsCargonvdIndicator;
        }
        ...
        /// <summary>
        /// Gets or Sets CargocoveringOrganization
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#coveringOrganization", EmitDefaultValue = false)]
        public Organization HttpsCargocoveringOrganization { get; set; }

        /// <summary>
        /// Gets or Sets CargoinsuredAmount
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#insuredAmount", EmitDefaultValue = false)]
        public Value HttpsCargoinsuredAmount { get; set; }

        /// <summary>
        /// Gets or Sets CargoinsuredShipment
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#insuredShipment", EmitDefaultValue = false)]
        public Shipment HttpsCargoinsuredShipment { get; set; }

        /// <summary>
        /// Gets or Sets CargonvdIndicator
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#nvdIndicator", EmitDefaultValue = true)]
        public bool HttpsCargonvdIndicator { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CargocoveringOrganization: ").Append(HttpsCargocoveringOrganization).Append("\n");
            sb.Append("  CargoinsuredAmount: ").Append(HttpsCargoinsuredAmount).Append("\n");
            sb.Append("  CargoinsuredShipment: ").Append(HttpsCargoinsuredShipment).Append("\n");
            sb.Append("  CargonvdIndicator: ").Append(HttpsCargonvdIndicator).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(httpsInput as Insurance);
        }

        /// <summary>
        /// Returns true if Insurance instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of Insurance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Insurance httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.HttpsCargocoveringOrganization == httpsInput.HttpsCargocoveringOrganization ||
                    (this.HttpsCargocoveringOrganization != null &&
                    this.HttpsCargocoveringOrganization.Equals(httpsInput.HttpsCargocoveringOrganization))
                ) && 
                (
                    this.HttpsCargoinsuredAmount == httpsInput.HttpsCargoinsuredAmount ||
                    (this.HttpsCargoinsuredAmount != null &&
                    this.HttpsCargoinsuredAmount.Equals(httpsInput.HttpsCargoinsuredAmount))
                ) && 
                (
                    this.HttpsCargoinsuredShipment == httpsInput.HttpsCargoinsuredShipment ||
                    (this.HttpsCargoinsuredShipment != null &&
                    this.HttpsCargoinsuredShipment.Equals(httpsInput.HttpsCargoinsuredShipment))
                ) && 
                (
                    this.HttpsCargonvdIndicator == httpsInput.HttpsCargonvdIndicator ||
                    this.HttpsCargonvdIndicator.Equals(httpsInput.HttpsCargonvdIndicator)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HttpsCargocoveringOrganization != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargocoveringOrganization.GetHashCode();
                }
                if (this.HttpsCargoinsuredAmount != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargoinsuredAmount.GetHashCode();
                }
                if (this.HttpsCargoinsuredShipment != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargoinsuredShipment.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.HttpsCargonvdIndicator.GetHashCode();
                return hashCode;
            }
        }
