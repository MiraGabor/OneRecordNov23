...
namespace OneRecord.Api.SDK.Model
{
    ...
    /// SensorGeoloc
    /// </summary>
    [DataContract(Name = "SensorGeoloc")]
    public partial class SensorGeoloc : IEquatable<SensorGeoloc>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SensorGeoloc" /> class.
        /// </summary>
        ...
        public SensorGeoloc(string httpsId = default(string), List<string> httpsType = default(List<string>), List<Check> httpsCargochecks = default(List<Check>), List<LogisticsEvent> httpsCargoevents = default(List<LogisticsEvent>), List<ExternalReference> httpsCargoexternalReferences = default(List<ExternalReference>), string httpsCargocompanyIdentifier = default(string), bool httpsCargoskeletonIndicator = default(bool), List<IotDevice> httpsCargoattachedIotDevices = default(List<IotDevice>), List<LogisticsAction> httpsCargoinvolvedInActions = default(List<LogisticsAction>), List<Measurement> httpsCargomeasurements = default(List<Measurement>), IotDevice httpsCargopartOfIotDevice = default(IotDevice), string httpsCargodescription = default(string), string httpsCargoname = default(string), string httpsCargosensorType = default(string), string httpsCargoserialNumber = default(string), List<MeasurementsGeoloc> httpsCargomeasurementsGeoloc = default(List<MeasurementsGeoloc>))
        {
            ...
            this.HttpsCargomeasurementsGeoloc = httpsCargomeasurementsGeoloc;
        }
        ...
        /// <summary>
        /// Gets or Sets CargomeasurementsGeoloc
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#measurementsGeoloc", EmitDefaultValue = false)]
        public List<MeasurementsGeoloc> HttpsCargomeasurementsGeoloc { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CargomeasurementsGeoloc: ").Append(HttpsCargomeasurementsGeoloc).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(httpsInput as SensorGeoloc);
        }

        /// <summary>
        /// Returns true if SensorGeoloc instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of SensorGeoloc to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SensorGeoloc httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.HttpsCargomeasurementsGeoloc == httpsInput.HttpsCargomeasurementsGeoloc ||
                    this.HttpsCargomeasurementsGeoloc != null &&
                    httpsInput.HttpsCargomeasurementsGeoloc != null &&
                    this.HttpsCargomeasurementsGeoloc.SequenceEqual(httpsInput.HttpsCargomeasurementsGeoloc)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HttpsCargomeasurementsGeoloc != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargomeasurementsGeoloc.GetHashCode();
                }
                return hashCode;
            }
        }
