...
namespace OneRecord.Api.SDK.Model
{
    ...
    public partial class UnitComposition : IEquatable<UnitComposition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnitComposition" /> class.
        /// </summary>
        ...
        public UnitComposition(string httpsId = default(string), List<string> httpsType = default(List<string>), List<Check> httpsCargochecks = default(List<Check>), List<LogisticsEvent> httpsCargoevents = default(List<LogisticsEvent>), List<ExternalReference> httpsCargoexternalReferences = default(List<ExternalReference>), string httpsCargocompanyIdentifier = default(string), bool httpsCargoskeletonIndicator = default(bool), List<Check> httpsCargocheckActions = default(List<Check>), List<ContactDetail> httpsCargocontactDetails = default(List<ContactDetail>), List<Person> httpsCargocontactPersons = default(List<Person>), List<LogisticsService> httpsCargoservedServices = default(List<LogisticsService>), string httpsCargoexecutionStatus = default(string), List<Composing> httpsCargocompositionActions = default(List<Composing>), string httpsCargocompositionIdentifier = default(string))
        {
            ...
            this.HttpsCargocompositionActions = httpsCargocompositionActions;
            this.HttpsCargocompositionIdentifier = httpsCargocompositionIdentifier;
        }
        ...
        /// <summary>
        /// Gets or Sets CargocompositionActions
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#compositionActions", EmitDefaultValue = false)]
        public List<Composing> HttpsCargocompositionActions { get; set; }

        /// <summary>
        /// Gets or Sets CargocompositionIdentifier
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#compositionIdentifier", EmitDefaultValue = false)]
        public string HttpsCargocompositionIdentifier { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UnitComposition {\n");
            ...
            sb.Append("  CargocompositionActions: ").Append(HttpsCargocompositionActions).Append("\n");
            sb.Append("  CargocompositionIdentifier: ").Append(HttpsCargocompositionIdentifier).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(httpsInput as UnitComposition);
        }

        /// <summary>
        /// Returns true if UnitComposition instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of UnitComposition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnitComposition httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.HttpsCargocompositionActions == httpsInput.HttpsCargocompositionActions ||
                    this.HttpsCargocompositionActions != null &&
                    httpsInput.HttpsCargocompositionActions != null &&
                    this.HttpsCargocompositionActions.SequenceEqual(httpsInput.HttpsCargocompositionActions)
                ) && 
                (
                    this.HttpsCargocompositionIdentifier == httpsInput.HttpsCargocompositionIdentifier ||
                    (this.HttpsCargocompositionIdentifier != null &&
                    this.HttpsCargocompositionIdentifier.Equals(httpsInput.HttpsCargocompositionIdentifier))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HttpsCargocompositionActions != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargocompositionActions.GetHashCode();
                }
                if (this.HttpsCargocompositionIdentifier != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargocompositionIdentifier.GetHashCode();
                }
                return hashCode;
            }
        }
