...
namespace OneRecord.Api.SDK.Model
{
    ...
    public partial class Moving : IEquatable<Moving>, IValidatableObject
    {
        /// <summary>
        ...
        public Moving(string httpsId = default(string), List<string> httpsType = default(List<string>), List<Check> httpsCargochecks = default(List<Check>), List<LogisticsEvent> httpsCargoevents = default(List<LogisticsEvent>), List<ExternalReference> httpsCargoexternalReferences = default(List<ExternalReference>), string httpsCargocompanyIdentifier = default(string), bool httpsCargoskeletonIndicator = default(bool), List<ContactDetail> httpsCargocontactDetails = default(List<ContactDetail>), List<Person> httpsCargocontactPersons = default(List<Person>), Location httpsCargolocationOfPerformance = default(Location), LogisticsActivity httpsCargoservedActivity = default(LogisticsActivity), DateTime httpsCargoactionEndTime = default(DateTime), DateTime httpsCargoactionStartTime = default(DateTime), string httpsCargoactionTimeType = default(string), string httpsCargomovementType = default(string))
        {
            ...
            this.HttpsCargomovementType = httpsCargomovementType;
        }
        ...
        /// <summary>
        /// Gets or Sets CargomovementType
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#movementType", EmitDefaultValue = false)]
        public string HttpsCargomovementType { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CargomovementType: ").Append(HttpsCargomovementType).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(httpsInput as Moving);
        }

        /// <summary>
        /// Returns true if Moving instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of Moving to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Moving httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.HttpsCargomovementType == httpsInput.HttpsCargomovementType ||
                    (this.HttpsCargomovementType != null &&
                    this.HttpsCargomovementType.Equals(httpsInput.HttpsCargomovementType))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HttpsCargomovementType != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargomovementType.GetHashCode();
                }
                return hashCode;
            }
        }
