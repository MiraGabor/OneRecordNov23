...
namespace OneRecord.Api.SDK.Model
{
    ...
    public partial class GetActionRequest200Response : AbstractOpenApiSchema, IEquatable<GetActionRequest200Response>, IValidatableObject
    {
        ...
        {
            return this.Equals(httpsInput as GetActionRequest200Response);
        }

        /// <summary>
        /// Returns true if GetActionRequest200Response instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of GetActionRequest200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetActionRequest200Response httpsInput)
        {
            if (httpsInput == null)
                return false;
