...
namespace OneRecord.Api.SDK.Model
{
    ...
    public partial class LoadingActivity : IEquatable<LoadingActivity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoadingActivity" /> class.
        /// </summary>
        ...
        public LoadingActivity(string httpsId = default(string), List<string> httpsType = default(List<string>), List<Check> httpsCargochecks = default(List<Check>), List<LogisticsEvent> httpsCargoevents = default(List<LogisticsEvent>), List<ExternalReference> httpsCargoexternalReferences = default(List<ExternalReference>), string httpsCargocompanyIdentifier = default(string), bool httpsCargoskeletonIndicator = default(bool), List<Check> httpsCargocheckActions = default(List<Check>), List<ContactDetail> httpsCargocontactDetails = default(List<ContactDetail>), List<Person> httpsCargocontactPersons = default(List<Person>), List<LogisticsService> httpsCargoservedServices = default(List<LogisticsService>), string httpsCargoexecutionStatus = default(string), List<Loading> httpsCargoloadingActions = default(List<Loading>), string httpsCargoloadingIdentifier = default(string))
        {
            ...
            this.HttpsCargoloadingActions = httpsCargoloadingActions;
            this.HttpsCargoloadingIdentifier = httpsCargoloadingIdentifier;
        }
        ...
        /// <summary>
        /// Gets or Sets CargoloadingActions
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#loadingActions", EmitDefaultValue = false)]
        public List<Loading> HttpsCargoloadingActions { get; set; }

        /// <summary>
        /// Gets or Sets CargoloadingIdentifier
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#loadingIdentifier", EmitDefaultValue = false)]
        public string HttpsCargoloadingIdentifier { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LoadingActivity {\n");
            ...
            sb.Append("  CargoloadingActions: ").Append(HttpsCargoloadingActions).Append("\n");
            sb.Append("  CargoloadingIdentifier: ").Append(HttpsCargoloadingIdentifier).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(httpsInput as LoadingActivity);
        }

        /// <summary>
        /// Returns true if LoadingActivity instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of LoadingActivity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoadingActivity httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.HttpsCargoloadingActions == httpsInput.HttpsCargoloadingActions ||
                    this.HttpsCargoloadingActions != null &&
                    httpsInput.HttpsCargoloadingActions != null &&
                    this.HttpsCargoloadingActions.SequenceEqual(httpsInput.HttpsCargoloadingActions)
                ) && 
                (
                    this.HttpsCargoloadingIdentifier == httpsInput.HttpsCargoloadingIdentifier ||
                    (this.HttpsCargoloadingIdentifier != null &&
                    this.HttpsCargoloadingIdentifier.Equals(httpsInput.HttpsCargoloadingIdentifier))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HttpsCargoloadingActions != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargoloadingActions.GetHashCode();
                }
                if (this.HttpsCargoloadingIdentifier != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargoloadingIdentifier.GetHashCode();
                }
                return hashCode;
            }
        }
