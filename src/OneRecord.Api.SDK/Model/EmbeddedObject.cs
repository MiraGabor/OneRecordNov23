...
namespace OneRecord.Api.SDK.Model
{
    ...
    /// EmbeddedObject
    /// </summary>
    [DataContract(Name = "EmbeddedObject")]
    public partial class EmbeddedObject : IEquatable<EmbeddedObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbeddedObject" /> class.
        /// </summary>
        /// <param name="httpsId">id.</param>
        /// <param name="httpsType">type.</param>
        /// <param name="httpsCargocompanyIdentifier">CargocompanyIdentifier.</param>
        public EmbeddedObject(string httpsId = default(string), List<string> httpsType = default(List<string>), string httpsCargocompanyIdentifier = default(string))
        {
        ...
        {
            return this.Equals(httpsInput as EmbeddedObject);
        }

        /// <summary>
        /// Returns true if EmbeddedObject instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of EmbeddedObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmbeddedObject httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
