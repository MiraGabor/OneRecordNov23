...
namespace OneRecord.Api.SDK.Model
{
    ...
    public partial class BookingTimes : IEquatable<BookingTimes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BookingTimes" /> class.
        /// </summary>
        ...
        /// <param name="httpsCargoearliestAcceptanceTime">CargoearliestAcceptanceTime.</param>
        /// <param name="httpsCargolatestAcceptanceTime">CargolatestAcceptanceTime.</param>
        /// <param name="httpsCargolatestArrivalTime">CargolatestArrivalTime.</param>
        /// <param name="httpsCargotimeOfAvailability">CargotimeOfAvailability.</param>
        /// <param name="httpsCargototalTransitTime">CargototalTransitTime.</param>
        public BookingTimes(string httpsId = default(string), List<string> httpsType = default(List<string>), List<Check> httpsCargochecks = default(List<Check>), List<LogisticsEvent> httpsCargoevents = default(List<LogisticsEvent>), List<ExternalReference> httpsCargoexternalReferences = default(List<ExternalReference>), string httpsCargocompanyIdentifier = default(string), bool httpsCargoskeletonIndicator = default(bool), BookingOptionRequest httpsCargoforBookingOptionRequest = default(BookingOptionRequest), BookingOption httpsCargoforBookingOptions = default(BookingOption), DateTime httpsCargoearliestAcceptanceTime = default(DateTime), DateTime httpsCargolatestAcceptanceTime = default(DateTime), DateTime httpsCargolatestArrivalTime = default(DateTime), DateTime httpsCargotimeOfAvailability = default(DateTime), string httpsCargototalTransitTime = default(string))
        {
            ...
            this.HttpsCargoearliestAcceptanceTime = httpsCargoearliestAcceptanceTime;
            this.HttpsCargolatestAcceptanceTime = httpsCargolatestAcceptanceTime;
            this.HttpsCargolatestArrivalTime = httpsCargolatestArrivalTime;
            this.HttpsCargotimeOfAvailability = httpsCargotimeOfAvailability;
            this.HttpsCargototalTransitTime = httpsCargototalTransitTime;
        }
        ...
        /// <summary>
        /// Gets or Sets CargoearliestAcceptanceTime
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#earliestAcceptanceTime", EmitDefaultValue = false)]
        public DateTime HttpsCargoearliestAcceptanceTime { get; set; }

        /// <summary>
        /// Gets or Sets CargolatestAcceptanceTime
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#latestAcceptanceTime", EmitDefaultValue = false)]
        public DateTime HttpsCargolatestAcceptanceTime { get; set; }

        /// <summary>
        /// Gets or Sets CargolatestArrivalTime
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#latestArrivalTime", EmitDefaultValue = false)]
        public DateTime HttpsCargolatestArrivalTime { get; set; }

        /// <summary>
        /// Gets or Sets CargotimeOfAvailability
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#timeOfAvailability", EmitDefaultValue = false)]
        public DateTime HttpsCargotimeOfAvailability { get; set; }

        /// <summary>
        /// Gets or Sets CargototalTransitTime
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#totalTransitTime", EmitDefaultValue = false)]
        public string HttpsCargototalTransitTime { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CargoearliestAcceptanceTime: ").Append(HttpsCargoearliestAcceptanceTime).Append("\n");
            sb.Append("  CargolatestAcceptanceTime: ").Append(HttpsCargolatestAcceptanceTime).Append("\n");
            sb.Append("  CargolatestArrivalTime: ").Append(HttpsCargolatestArrivalTime).Append("\n");
            sb.Append("  CargotimeOfAvailability: ").Append(HttpsCargotimeOfAvailability).Append("\n");
            sb.Append("  CargototalTransitTime: ").Append(HttpsCargototalTransitTime).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(httpsInput as BookingTimes);
        }

        /// <summary>
        /// Returns true if BookingTimes instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of BookingTimes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BookingTimes httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.HttpsCargoearliestAcceptanceTime == httpsInput.HttpsCargoearliestAcceptanceTime ||
                    (this.HttpsCargoearliestAcceptanceTime != null &&
                    this.HttpsCargoearliestAcceptanceTime.Equals(httpsInput.HttpsCargoearliestAcceptanceTime))
                ) && 
                (
                    this.HttpsCargolatestAcceptanceTime == httpsInput.HttpsCargolatestAcceptanceTime ||
                    (this.HttpsCargolatestAcceptanceTime != null &&
                    this.HttpsCargolatestAcceptanceTime.Equals(httpsInput.HttpsCargolatestAcceptanceTime))
                ) && 
                (
                    this.HttpsCargolatestArrivalTime == httpsInput.HttpsCargolatestArrivalTime ||
                    (this.HttpsCargolatestArrivalTime != null &&
                    this.HttpsCargolatestArrivalTime.Equals(httpsInput.HttpsCargolatestArrivalTime))
                ) && 
                (
                    this.HttpsCargotimeOfAvailability == httpsInput.HttpsCargotimeOfAvailability ||
                    (this.HttpsCargotimeOfAvailability != null &&
                    this.HttpsCargotimeOfAvailability.Equals(httpsInput.HttpsCargotimeOfAvailability))
                ) && 
                (
                    this.HttpsCargototalTransitTime == httpsInput.HttpsCargototalTransitTime ||
                    (this.HttpsCargototalTransitTime != null &&
                    this.HttpsCargototalTransitTime.Equals(httpsInput.HttpsCargototalTransitTime))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HttpsCargoearliestAcceptanceTime != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargoearliestAcceptanceTime.GetHashCode();
                }
                if (this.HttpsCargolatestAcceptanceTime != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargolatestAcceptanceTime.GetHashCode();
                }
                if (this.HttpsCargolatestArrivalTime != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargolatestArrivalTime.GetHashCode();
                }
                if (this.HttpsCargotimeOfAvailability != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargotimeOfAvailability.GetHashCode();
                }
                if (this.HttpsCargototalTransitTime != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargototalTransitTime.GetHashCode();
                }
                return hashCode;
            }
        }
