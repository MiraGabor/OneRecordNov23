...
namespace OneRecord.Api.SDK.Model
{
    ...
    public partial class Company : IEquatable<Company>, IValidatableObject
    {
        ...
        {
            return this.Equals(httpsInput as Company);
        }

        /// <summary>
        /// Returns true if Company instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of Company to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Company httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
