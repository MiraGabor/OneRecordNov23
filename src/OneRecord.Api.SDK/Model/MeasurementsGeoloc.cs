...
namespace OneRecord.Api.SDK.Model
{
    ...
    /// MeasurementsGeoloc
    /// </summary>
    [DataContract(Name = "MeasurementsGeoloc")]
    public partial class MeasurementsGeoloc : IEquatable<MeasurementsGeoloc>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeasurementsGeoloc" /> class.
        /// </summary>
        ...
        public MeasurementsGeoloc(string httpsId = default(string), List<string> httpsType = default(List<string>), Value httpsCargomeasurementValue = default(Value), Geolocation httpsCargorecordedGeolocation = default(Geolocation), DateTime httpsCargomeasurementTimestamp = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MeasurementsGeoloc {\n");
        ...
        {
            return this.Equals(httpsInput as MeasurementsGeoloc);
        }

        /// <summary>
        /// Returns true if MeasurementsGeoloc instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of MeasurementsGeoloc to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeasurementsGeoloc httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
