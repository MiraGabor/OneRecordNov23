...
namespace OneRecord.Api.SDK.Model
{
    ...
    /// MeasurementsOther
    /// </summary>
    [DataContract(Name = "MeasurementsOther")]
    public partial class MeasurementsOther : IEquatable<MeasurementsOther>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeasurementsOther" /> class.
        /// </summary>
        ...
        /// <param name="httpsCargootherMeasurement">CargootherMeasurement.</param>
        public MeasurementsOther(string httpsId = default(string), List<string> httpsType = default(List<string>), Value httpsCargomeasurementValue = default(Value), Geolocation httpsCargorecordedGeolocation = default(Geolocation), DateTime httpsCargomeasurementTimestamp = default(DateTime), Value httpsCargootherMeasurement = default(Value))
        {
            ...
            this.HttpsCargootherMeasurement = httpsCargootherMeasurement;
        }
        ...
        /// <summary>
        /// Gets or Sets CargootherMeasurement
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#otherMeasurement", EmitDefaultValue = false)]
        public Value HttpsCargootherMeasurement { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MeasurementsOther {\n");
            ...
            sb.Append("  CargootherMeasurement: ").Append(HttpsCargootherMeasurement).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(httpsInput as MeasurementsOther);
        }

        /// <summary>
        /// Returns true if MeasurementsOther instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of MeasurementsOther to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeasurementsOther httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.HttpsCargootherMeasurement == httpsInput.HttpsCargootherMeasurement ||
                    (this.HttpsCargootherMeasurement != null &&
                    this.HttpsCargootherMeasurement.Equals(httpsInput.HttpsCargootherMeasurement))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HttpsCargootherMeasurement != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargootherMeasurement.GetHashCode();
                }
                return hashCode;
            }
        }
