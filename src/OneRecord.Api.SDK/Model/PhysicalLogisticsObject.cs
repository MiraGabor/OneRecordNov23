...
namespace OneRecord.Api.SDK.Model
{
    ...
    public partial class PhysicalLogisticsObject : IEquatable<PhysicalLogisticsObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PhysicalLogisticsObject" /> class.
        /// </summary>
        ...
        public PhysicalLogisticsObject(string httpsId = default(string), List<string> httpsType = default(List<string>), List<Check> httpsCargochecks = default(List<Check>), List<LogisticsEvent> httpsCargoevents = default(List<LogisticsEvent>), List<ExternalReference> httpsCargoexternalReferences = default(List<ExternalReference>), string httpsCargocompanyIdentifier = default(string), bool httpsCargoskeletonIndicator = default(bool), List<IotDevice> httpsCargoattachedIotDevices = default(List<IotDevice>), List<LogisticsAction> httpsCargoinvolvedInActions = default(List<LogisticsAction>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PhysicalLogisticsObject {\n");
        ...
        {
            return this.Equals(httpsInput as PhysicalLogisticsObject);
        }

        /// <summary>
        /// Returns true if PhysicalLogisticsObject instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of PhysicalLogisticsObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PhysicalLogisticsObject httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
