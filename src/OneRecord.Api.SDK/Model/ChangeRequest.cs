...
namespace OneRecord.Api.SDK.Model
{
    ...
    public partial class ChangeRequest : IEquatable<ChangeRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(httpsInput as ChangeRequest);
        }

        /// <summary>
        /// Returns true if ChangeRequest instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of ChangeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangeRequest httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
