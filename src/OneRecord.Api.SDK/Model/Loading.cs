...
namespace OneRecord.Api.SDK.Model
{
    ...
    public partial class Loading : IEquatable<Loading>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="httpsCargoloadedMaterials">CargoloadedMaterials.</param>
        /// <param name="httpsCargoloadedPieces">CargoloadedPieces.</param>
        /// <param name="httpsCargoloadedUnits">CargoloadedUnits.</param>
        /// <param name="httpsCargoonTransportMeans">CargoonTransportMeans.</param>
        /// <param name="httpsCargoloadingPositionIdentifier">CargoloadingPositionIdentifier.</param>
        /// <param name="httpsCargoloadingType">CargoloadingType.</param>
        public Loading(string httpsId = default(string), List<string> httpsType = default(List<string>), List<Check> httpsCargochecks = default(List<Check>), List<LogisticsEvent> httpsCargoevents = default(List<LogisticsEvent>), List<ExternalReference> httpsCargoexternalReferences = default(List<ExternalReference>), string httpsCargocompanyIdentifier = default(string), bool httpsCargoskeletonIndicator = default(bool), List<ContactDetail> httpsCargocontactDetails = default(List<ContactDetail>), List<Person> httpsCargocontactPersons = default(List<Person>), Location httpsCargolocationOfPerformance = default(Location), LogisticsActivity httpsCargoservedActivity = default(LogisticsActivity), DateTime httpsCargoactionEndTime = default(DateTime), DateTime httpsCargoactionStartTime = default(DateTime), string httpsCargoactionTimeType = default(string), List<LoadingMaterial> httpsCargoloadedMaterials = default(List<LoadingMaterial>), List<Piece> httpsCargoloadedPieces = default(List<Piece>), List<LoadingUnit> httpsCargoloadedUnits = default(List<LoadingUnit>), TransportMeans httpsCargoonTransportMeans = default(TransportMeans), string httpsCargoloadingPositionIdentifier = default(string), string httpsCargoloadingType = default(string))
        {
            ...
            this.HttpsCargoloadedMaterials = httpsCargoloadedMaterials;
            this.HttpsCargoloadedPieces = httpsCargoloadedPieces;
            this.HttpsCargoloadedUnits = httpsCargoloadedUnits;
            this.HttpsCargoonTransportMeans = httpsCargoonTransportMeans;
            this.HttpsCargoloadingPositionIdentifier = httpsCargoloadingPositionIdentifier;
            this.HttpsCargoloadingType = httpsCargoloadingType;
        }
        ...
        /// <summary>
        /// Gets or Sets CargoloadedMaterials
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#loadedMaterials", EmitDefaultValue = false)]
        public List<LoadingMaterial> HttpsCargoloadedMaterials { get; set; }

        /// <summary>
        /// Gets or Sets CargoloadedPieces
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#loadedPieces", EmitDefaultValue = false)]
        public List<Piece> HttpsCargoloadedPieces { get; set; }

        /// <summary>
        /// Gets or Sets CargoloadedUnits
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#loadedUnits", EmitDefaultValue = false)]
        public List<LoadingUnit> HttpsCargoloadedUnits { get; set; }

        /// <summary>
        /// Gets or Sets CargoonTransportMeans
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#onTransportMeans", EmitDefaultValue = false)]
        public TransportMeans HttpsCargoonTransportMeans { get; set; }

        /// <summary>
        /// Gets or Sets CargoloadingPositionIdentifier
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#loadingPositionIdentifier", EmitDefaultValue = false)]
        public string HttpsCargoloadingPositionIdentifier { get; set; }

        /// <summary>
        /// Gets or Sets CargoloadingType
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#loadingType", EmitDefaultValue = false)]
        public string HttpsCargoloadingType { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CargoloadedMaterials: ").Append(HttpsCargoloadedMaterials).Append("\n");
            sb.Append("  CargoloadedPieces: ").Append(HttpsCargoloadedPieces).Append("\n");
            sb.Append("  CargoloadedUnits: ").Append(HttpsCargoloadedUnits).Append("\n");
            sb.Append("  CargoonTransportMeans: ").Append(HttpsCargoonTransportMeans).Append("\n");
            sb.Append("  CargoloadingPositionIdentifier: ").Append(HttpsCargoloadingPositionIdentifier).Append("\n");
            sb.Append("  CargoloadingType: ").Append(HttpsCargoloadingType).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(httpsInput as Loading);
        }

        /// <summary>
        /// Returns true if Loading instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of Loading to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Loading httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.HttpsCargoloadedMaterials == httpsInput.HttpsCargoloadedMaterials ||
                    this.HttpsCargoloadedMaterials != null &&
                    httpsInput.HttpsCargoloadedMaterials != null &&
                    this.HttpsCargoloadedMaterials.SequenceEqual(httpsInput.HttpsCargoloadedMaterials)
                ) && 
                (
                    this.HttpsCargoloadedPieces == httpsInput.HttpsCargoloadedPieces ||
                    this.HttpsCargoloadedPieces != null &&
                    httpsInput.HttpsCargoloadedPieces != null &&
                    this.HttpsCargoloadedPieces.SequenceEqual(httpsInput.HttpsCargoloadedPieces)
                ) && 
                (
                    this.HttpsCargoloadedUnits == httpsInput.HttpsCargoloadedUnits ||
                    this.HttpsCargoloadedUnits != null &&
                    httpsInput.HttpsCargoloadedUnits != null &&
                    this.HttpsCargoloadedUnits.SequenceEqual(httpsInput.HttpsCargoloadedUnits)
                ) && 
                (
                    this.HttpsCargoonTransportMeans == httpsInput.HttpsCargoonTransportMeans ||
                    (this.HttpsCargoonTransportMeans != null &&
                    this.HttpsCargoonTransportMeans.Equals(httpsInput.HttpsCargoonTransportMeans))
                ) && 
                (
                    this.HttpsCargoloadingPositionIdentifier == httpsInput.HttpsCargoloadingPositionIdentifier ||
                    (this.HttpsCargoloadingPositionIdentifier != null &&
                    this.HttpsCargoloadingPositionIdentifier.Equals(httpsInput.HttpsCargoloadingPositionIdentifier))
                ) && 
                (
                    this.HttpsCargoloadingType == httpsInput.HttpsCargoloadingType ||
                    (this.HttpsCargoloadingType != null &&
                    this.HttpsCargoloadingType.Equals(httpsInput.HttpsCargoloadingType))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HttpsCargoloadedMaterials != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargoloadedMaterials.GetHashCode();
                }
                if (this.HttpsCargoloadedPieces != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargoloadedPieces.GetHashCode();
                }
                if (this.HttpsCargoloadedUnits != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargoloadedUnits.GetHashCode();
                }
                if (this.HttpsCargoonTransportMeans != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargoonTransportMeans.GetHashCode();
                }
                if (this.HttpsCargoloadingPositionIdentifier != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargoloadingPositionIdentifier.GetHashCode();
                }
                if (this.HttpsCargoloadingType != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargoloadingType.GetHashCode();
                }
                return hashCode;
            }
        }
