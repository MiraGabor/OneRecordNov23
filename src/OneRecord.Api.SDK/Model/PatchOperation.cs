...
namespace OneRecord.Api.SDK.Model
{
    ...
    public partial class PatchOperation : IEquatable<PatchOperation>, IValidatableObject
    {
        ...
        public PatchOperation(string httpsId = default(string), List<string> httpsType = default(List<string>))
        {
        ...
        {
            return this.Equals(httpsInput as PatchOperation);
        }

        /// <summary>
        /// Returns true if PatchOperation instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of PatchOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchOperation httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
