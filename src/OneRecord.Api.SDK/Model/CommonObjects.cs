...
namespace OneRecord.Api.SDK.Model
{
    ...
    /// CommonObjects
    /// </summary>
    [DataContract(Name = "CommonObjects")]
    public partial class CommonObjects : IEquatable<CommonObjects>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonObjects" /> class.
        /// </summary>
        /// <param name="httpsId">id.</param>
        /// <param name="httpsType">type.</param>
        /// <param name="httpsCargocompanyIdentifier">CargocompanyIdentifier.</param>
        public CommonObjects(string httpsId = default(string), List<string> httpsType = default(List<string>), string httpsCargocompanyIdentifier = default(string))
        {
        ...
        {
            return this.Equals(httpsInput as CommonObjects);
        }

        /// <summary>
        /// Returns true if CommonObjects instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of CommonObjects to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommonObjects httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
