...
namespace OneRecord.Api.SDK.Model
{
    ...
    public partial class Storing : IEquatable<Storing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Storing" /> class.
        /// </summary>
        ...
        public Storing(string httpsId = default(string), List<string> httpsType = default(List<string>), List<Check> httpsCargochecks = default(List<Check>), List<LogisticsEvent> httpsCargoevents = default(List<LogisticsEvent>), List<ExternalReference> httpsCargoexternalReferences = default(List<ExternalReference>), string httpsCargocompanyIdentifier = default(string), bool httpsCargoskeletonIndicator = default(bool), List<ContactDetail> httpsCargocontactDetails = default(List<ContactDetail>), List<Person> httpsCargocontactPersons = default(List<Person>), Location httpsCargolocationOfPerformance = default(Location), LogisticsActivity httpsCargoservedActivity = default(LogisticsActivity), DateTime httpsCargoactionEndTime = default(DateTime), DateTime httpsCargoactionStartTime = default(DateTime), string httpsCargoactionTimeType = default(string), List<PhysicalLogisticsObject> httpsCargostoredObjects = default(List<PhysicalLogisticsObject>), string httpsCargostoragePlaceIdentifier = default(string), string httpsCargostoringType = default(string))
        {
            ...
            this.HttpsCargostoredObjects = httpsCargostoredObjects;
            this.HttpsCargostoragePlaceIdentifier = httpsCargostoragePlaceIdentifier;
            this.HttpsCargostoringType = httpsCargostoringType;
        }
        ...
        /// <summary>
        /// Gets or Sets CargostoredObjects
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#storedObjects", EmitDefaultValue = false)]
        public List<PhysicalLogisticsObject> HttpsCargostoredObjects { get; set; }

        /// <summary>
        /// Gets or Sets CargostoragePlaceIdentifier
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#storagePlaceIdentifier", EmitDefaultValue = false)]
        public string HttpsCargostoragePlaceIdentifier { get; set; }

        /// <summary>
        /// Gets or Sets CargostoringType
        /// </summary>
        [DataMember(Name = "https://onerecord.iata.org/ns/cargo#storingType", EmitDefaultValue = false)]
        public string HttpsCargostoringType { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CargostoredObjects: ").Append(HttpsCargostoredObjects).Append("\n");
            sb.Append("  CargostoragePlaceIdentifier: ").Append(HttpsCargostoragePlaceIdentifier).Append("\n");
            sb.Append("  CargostoringType: ").Append(HttpsCargostoringType).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(httpsInput as Storing);
        }

        /// <summary>
        /// Returns true if Storing instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of Storing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Storing httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.HttpsCargostoredObjects == httpsInput.HttpsCargostoredObjects ||
                    this.HttpsCargostoredObjects != null &&
                    httpsInput.HttpsCargostoredObjects != null &&
                    this.HttpsCargostoredObjects.SequenceEqual(httpsInput.HttpsCargostoredObjects)
                ) && 
                (
                    this.HttpsCargostoragePlaceIdentifier == httpsInput.HttpsCargostoragePlaceIdentifier ||
                    (this.HttpsCargostoragePlaceIdentifier != null &&
                    this.HttpsCargostoragePlaceIdentifier.Equals(httpsInput.HttpsCargostoragePlaceIdentifier))
                ) && 
                (
                    this.HttpsCargostoringType == httpsInput.HttpsCargostoringType ||
                    (this.HttpsCargostoringType != null &&
                    this.HttpsCargostoringType.Equals(httpsInput.HttpsCargostoringType))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HttpsCargostoredObjects != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargostoredObjects.GetHashCode();
                }
                if (this.HttpsCargostoragePlaceIdentifier != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargostoragePlaceIdentifier.GetHashCode();
                }
                if (this.HttpsCargostoringType != null)
                {
                    hashCode = (hashCode * 59) + this.HttpsCargostoringType.GetHashCode();
                }
                return hashCode;
            }
        }
