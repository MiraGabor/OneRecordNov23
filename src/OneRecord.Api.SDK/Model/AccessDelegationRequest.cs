...
namespace OneRecord.Api.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccessDelegationRequest")]
    public partial class AccessDelegationRequest : IEquatable<AccessDelegationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessDelegationRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccessDelegationRequest {\n");
        ...
        {
            return this.Equals(httpsInput as AccessDelegationRequest);
        }

        /// <summary>
        /// Returns true if AccessDelegationRequest instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of AccessDelegationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccessDelegationRequest httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
