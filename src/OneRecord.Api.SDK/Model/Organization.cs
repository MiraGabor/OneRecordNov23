...
namespace OneRecord.Api.SDK.Model
{
    ...
    public partial class Organization : IEquatable<Organization>, IValidatableObject
    {
        ...
        {
            return this.Equals(httpsInput as Organization);
        }

        /// <summary>
        /// Returns true if Organization instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of Organization to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Organization httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
