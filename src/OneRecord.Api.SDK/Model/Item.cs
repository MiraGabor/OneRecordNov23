...
namespace OneRecord.Api.SDK.Model
{
    ...
    public partial class Item : IEquatable<Item>, IValidatableObject
    {
        ...
        {
            return this.Equals(httpsInput as Item);
        }

        /// <summary>
        /// Returns true if Item instances are equal
        /// </summary>
        /// <param name="httpsInput">Instance of Item to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Item httpsInput)
        {
            if (httpsInput == null)
            {
                return false;
